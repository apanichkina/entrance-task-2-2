...
/* harmony import */ var _RadioGroup_radioGroup__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../RadioGroup/radioGroup */ "./public/app/components/RadioGroup/radioGroup.js");
/**
...
class Popup {
  ...
  render(params) {
    ...
    if (params.actions) {
      ...
      const radioGroup = new _RadioGroup_radioGroup__WEBPACK_IMPORTED_MODULE_1__["default"](radioGroupContainer);
...
/* harmony default export */ __webpack_exports__["default"] = (function (__fest_context){"use strict";var __fest_self=this,__fest_buf="",__fest_chunks=[],__fest_chunk,__fest_attrs=[],__fest_select,__fest_if,__fest_iterator,__fest_to,__fest_fn,__fest_html="",__fest_blocks={},__fest_params,__fest_element,__fest_debug_file="",__fest_debug_line="",__fest_debug_block="",__fest_element_stack = [],__fest_short_tags = {"area": true, "base": true, "br": true, "col": true, "command": true, "embed": true, "hr": true, "img": true, "input": true, "keygen": true, "link": true, "meta": true, "param": true, "source": true, "wbr": true},__fest_jschars = /[\\'"\/\n\r\t\b\f<>]/g,__fest_jschars_test = /[\\'"\/\n\r\t\b\f<>]/,__fest_htmlchars = /[&<>"]/g,__fest_htmlchars_test = /[&<>"]/,__fest_jshash = {"\"": "\\\"", "\\": "\\\\", "/": "\\/", "\n": "\\n", "\r": "\\r", "\t": "\\t", "\b": "\\b", "\f": "\\f", "'": "\\'", "<": "\\u003C", ">": "\\u003E"},__fest_htmlhash = {"&": "&amp;", "<": "&lt;", ">": "&gt;", "\"": "&quot;"},__fest_escapeJS = function __fest_escapeJS(value) {
		...
		fn.param = true;
		return fn;
	},i18n=__fest_self && typeof __fest_self.i18n === "function" ? __fest_self.i18n : function (str) {return str;},___fest_log_error;if(typeof __fest_error === "undefined"){___fest_log_error = (typeof console !== "undefined" && console.error) ? function(){return Function.prototype.apply.call(console.error, console, arguments)} : function(){};}else{___fest_log_error=__fest_error};function __fest_log_error(msg){___fest_log_error(msg+"\nin block \""+__fest_debug_block+"\" at line: "+__fest_debug_line+"\nfile: "+__fest_debug_file)}function __fest_call(fn, params,cp){if(cp)for(var i in params)if(typeof params[i]=="function"&&params[i].param)params[i]=params[i]();return fn.call(__fest_self,params)}var params=__fest_context;__fest_buf+=("<div class=\"popup\"><div class=\"popup__content\"><div><div class=\"popup__title text__l text__bold\">");try{__fest_buf+=(__fest_escapeHTML(params.title))}catch(e){__fest_log_error(e.message + "5");}__fest_buf+=("</div><div class=\"popup__subtitle text__xs\">");try{__fest_buf+=(__fest_escapeHTML(params.subtitle))}catch(e){__fest_log_error(e.message + "8");}__fest_buf+=("</div><div class=\"popup__actions\"></div></div><div class=\"popup__controller\"></div></div>");try{__fest_if=params.confirm && params.cancel}catch(e){__fest_if=false;__fest_log_error(e.message);}if(__fest_if){__fest_buf+=("<div class=\"popup__button__container\"><button class=\"button button_confirm button_accent text__bold text__l\">");try{__fest_buf+=(__fest_escapeHTML(params.confirm))}catch(e){__fest_log_error(e.message + "19");}__fest_buf+=("</button><div class=\"button_space\"></div><button class=\"button button_cancel text__bold text__l js-button-close\">");try{__fest_buf+=(__fest_escapeHTML(params.cancel))}catch(e){__fest_log_error(e.message + "23");}__fest_buf+=("</button></div>");}__fest_buf+=("</div>");__fest_to=__fest_chunks.length;if (__fest_to) {__fest_iterator = 0;for (;__fest_iterator<__fest_to;__fest_iterator++) {__fest_chunk=__fest_chunks[__fest_iterator];if (typeof __fest_chunk==="string") {__fest_html+=__fest_chunk;} else {__fest_fn=__fest_blocks[__fest_chunk.name];if (__fest_fn) __fest_html+=__fest_call(__fest_fn,__fest_chunk.params,__fest_chunk.cp);}}return __fest_html+__fest_buf;} else {return __fest_buf;}});
...
/* harmony import */ var _components_RadioGroup_radioGroup__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./components/RadioGroup/radioGroup */ "./public/app/components/RadioGroup/radioGroup.js");
/* harmony import */ var _components_Popup_popup__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./components/Popup/popup */ "./public/app/components/Popup/popup.js");
/* harmony import */ var _components_Slider_slider__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./components/Slider/slider */ "./public/app/components/Slider/slider.js");
/* harmony import */ var _css_index_css__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../css/index.css */ "./public/css/index.css");
